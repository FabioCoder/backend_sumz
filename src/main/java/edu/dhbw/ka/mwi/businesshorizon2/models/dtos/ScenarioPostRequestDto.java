...
public class ScenarioPostRequestDto {
    ...
    public MultiPeriodAccountingFigureRequestDto getRevenue() {
        return revenue;
    }
    ...
    public MultiPeriodAccountingFigureRequestDto getAdditionalIncome() {
    ...
    public MultiPeriodAccountingFigureRequestDto getCostOfMaterial() {
    ...
    public MultiPeriodAccountingFigureRequestDto getCostOfStaff() {
        return costOfStaff;
    }
    ...
    public MultiPeriodAccountingFigureRequestDto getAdditionalCosts() {
    ...
    public MultiPeriodAccountingFigureRequestDto getInvestments() {
        return investments;
    }
    ...
    public MultiPeriodAccountingFigureRequestDto getDivestments() {
        return divestments;
    }
    ...
    public MultiPeriodAccountingFigureRequestDto getLiabilities() {
        return liabilities;
    }
    ...
    public MultiPeriodAccountingFigureRequestDto getFreeCashFlows() {
    ...
    public MultiPeriodAccountingFigureRequestDto getDepreciation() {
        return depreciation;
    }
